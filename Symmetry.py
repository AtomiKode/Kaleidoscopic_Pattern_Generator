...
class Paint(object):
    ...
    def __init__(self):
        ...
        self.choose_size_button = Scale(self.root, from_=1, to=25, orient=HORIZONTAL)
    ...
    def paint(self, event):
        if self.radiobuttonValue.get() == 1:
            ...
            if self.old_x and self.old_y:
                ...
                self.c.create_line(-self.old_x+600,self.old_y, -event.x+600, event.y,
                               width=self.line_width, fill=paint_color,
                               capstyle=ROUND, smooth=TRUE, splinesteps=36)
            ...
            if self.old_x and self.old_y:
                ...
                self.c.create_line(self.old_x , -self.old_y+600, event.x, -event.y+600,
                               width=self.line_width, fill=paint_color,
                               capstyle=ROUND, smooth=TRUE, splinesteps=36)

                self.c.create_line(-self.old_x +600, -self.old_y+600, -event.x+600, -event.y+600,
                               width=self.line_width, fill=paint_color,
                               capstyle=ROUND, smooth=TRUE, splinesteps=36)
